  ...
  return (
    <div className="relative">
      ...
      <section className="relative mx-auto max-w-[1600px] px-6 pb-16 pt-40 md:px-12 md:pb-24 md:pt-52">
        ...
        <Reveal delay={0.12}>
          <p className="mt-10 max-w-xl text-base leading-loose text-white/55 md:text-lg">
        ...
        <Reveal delay={0.18}>
          <div className="mt-14 flex flex-wrap gap-x-6 gap-y-3 border-t border-white/[0.06] pt-8">
            <FilterChip
              active={filter === "all"}
          ...
          >
            ...
            <div className="grid gap-10 md:grid-cols-12">
              <Reveal className="md:col-span-5">
                ...
                <h2 className="font-serif text-4xl leading-tight text-white md:text-5xl md:leading-tight">
                  {category.title}
                </h2>
              </Reveal>
              <Reveal className="md:col-span-6 md:col-start-7" delay={0.08}>
                <p className="text-base leading-loose text-white/55 md:text-lg">
      ...
      <section className="relative mx-auto max-w-3xl px-6 py-32 text-center md:px-12 md:py-48">
        ...
        <Reveal delay={0.1}>
          <p className="mt-10 text-[11px] uppercase tracking-[0.4em] text-white/35">
            — Studio Errant
          </p>
        </Reveal>
        <Reveal delay={0.15}>
          <button
            ...
            data-cursor="hover"
            className="group mt-12 inline-flex items-center gap-4 text-sm uppercase tracking-[0.3em] text-white/65 transition-colors hover:text-white"
          >
    ...
    >
      ...
      {active && (
        <motion.span
          ...
          className="absolute -bottom-2 left-0 h-px w-full bg-white/70"
